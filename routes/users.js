...
// router.route('/confirmbycompany')
//     .post(protect, authorize("0", "1"), confirmByCompany)

// router.route('/getconfirm')
//     .post(protect, getConfirmUser)

// router
//     .route('/companies')
//     .get(protect, authorize("0", "1"), userCompany)
// router
//     .route('/:id')
//     .get(protect, getUser)
//     .delete(
...
//     .delete(protect, authorize("0", "1"), destroyVote)

// router
//     .route("/:id/renew-confirm")
//     .get(protect, renewConfirmToken)
